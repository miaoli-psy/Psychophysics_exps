...
if __name__ == '__main__':
    ...
    stimuli_df['mycol'] = stimuli_df["positions_list"].apply(get_beam_n, args = (12, ))
    stimuli_df['mycol2'] = stimuli_df["positions_list"].apply(get_beam_n, args = (6, ))
    stimuli_df['mycol3'] = stimuli_df["positions_list"].apply(get_beam_n, args = (3, ))
