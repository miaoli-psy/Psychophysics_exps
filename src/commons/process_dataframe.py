...
# Notice: func_name is process each element in each column, instead of the whole column
...
def process_cols(input_df: pd.DataFrame, input_cols: list, func_name):
...
def insert_new_col_from_two_cols(input_df: pd.DataFrame, old_col1: str, old_col2, new_col: str, func_name):
